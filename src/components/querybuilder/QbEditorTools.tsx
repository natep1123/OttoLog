...
import { useLockController } from '../forms/LockController';

const MENU_WIDTH = 300;

/**
 * Slim Tools tray for the Query builder — Unlock & Expand All (workout DNA).
 * Skips "Collapse exercises" (no QB analog worth a second action yet).
 */
export function QbEditorTools() {
  ...
  const accent = layer.session.chip;
    ...
    <View style={styles.toolsWrap}>
      <View ref={triggerRef} collapsable={false} style={styles.anchor}>
        <Pressable
          ...
          accessibilityLabel="Query builder tools"
          style={({ pressed }) => [
            styles.trigger,
        ...
        <View style={styles.modalRoot}>
          ...
          >
            ...
            <Pressable
              ...
              accessibilityLabel="Unlock and expand all"
              style={({ pressed }) => [
                styles.action,
            ...
            >
              ...
              >
                <Text style={[styles.actionGlyphText, { color: accent.color }]}>
                  ◌
                </Text>
              </View>
              <View style={styles.actionCopy}>
                <Text style={styles.actionLabel}>Unlock & Expand All</Text>
                <Text style={styles.actionHint}>
                  Clear every lock and open every card in this query
                </Text>
              </View>
            </Pressable>
          </View>
