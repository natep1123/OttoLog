 ...
 * Must match sql/004_taxonomy.sql and sql/011_layer_labels.sql seeds.
 */
...
/** Block label system null — "General" */
export const GENERAL_BLOCK_LABEL_ID = '50000000-0000-4000-8000-000000000001';
/** Sequence label system null — "Standard" (internal cluster_labels table) */
