-- OttoLog Migration J — Session logs (relational fact layer)
-- (run in Supabase SQL Editor)
--
-- Requires: 001_users, 003_locked_atoms, 004_taxonomy, 005_analytics_taxonomy,
--           010_session_templates, 011_layer_labels
--
-- Per docs/Database_Outline.md § Logs + Recommended Build Order step 6.
-- Denest / renest live in the app (`src/lib/sessionLogs.ts`) for v1;
-- Postgres boundary RPCs can wrap the same shape later.
