# Analytics Overhaul — Proposal v1 (SUPERSEDED)

> **Historical only — do not implement from this file.**
> Superseded Jul 2026 by ../Analytics_Overhaul_Proposal.md (Approach E: PG-first query builder).
> Kept for audit trail (Hybrid / Simple+Power cube / lens×metric model).
